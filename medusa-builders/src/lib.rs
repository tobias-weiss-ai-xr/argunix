...
pub use side_channel::{
    ...
    DispatchOutcome as SideChannelDispatchOutcome, MAX_HEADER_BYTES, RuntimeClosureReply,
    SideChannelError, SideChannelHeader, SideChannelKind, ValidPathsReply, dispatch_inbound,
